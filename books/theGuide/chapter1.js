...
x1 === y // => false: equality
x1 !== y // => true: inequality
x1 < y // => true: less-than
x1 <= y // => true: less-than or equal
x1 > y // => false: greater-than
x1 >= y // => false: greater-than or equal
...
function plus1(x) {
  ...
  return x + 1 // Return a value one larger tha the value passed in
...
class Point {             // By convention, class names are capitalized.
  constructor(x, y) {     // Constructor function to initialize new instances.
    ...
    this.y = y;           // Store the function arguments as object properties.
  }                       // No return is necessary in constructor functions.

  distance() {            // Method to compute distance from origin to point.
    return Math.sqrt(     // Return the square root of x^2 + y^2.
      this.x * this.x +   // this refers to the Point object on which the distance is 
